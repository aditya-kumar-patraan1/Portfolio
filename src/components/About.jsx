export default function About() {
  return (
    <section className="chapter fade-up">
      ...
      <br />
      <p className="about-text">
        I build full-stack applications with real impact — from AI-powered medical platforms to real-time code collaboration tools. I'm driven by the intersection of Data Structures and modern web technologies, and I thrive when I can own a problem end-to-end: architecture, backend, frontend, and everything in between.
      </p>
    </section>
  )
}
