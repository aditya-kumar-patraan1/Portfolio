            ...
            <div className="container-custom section-padding">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {/* Dynamic Skill Cards */}
                        {[
                            { skill: "Dynamic Programming", level: 80, icon: "🧠", color: "from-blue-500 to-purple-500" },
                            { skill: "Data Structures", level: 88, icon: "🌳", color: "from-green-500 to-teal-500" },
                            { skill: "Hash Table", level: 89, icon: "⚡", color: "from-yellow-500 to-orange-500" },
                            { skill: "Binary Tree", level: 70, icon: "🕸️", color: "from-purple-500 to-pink-500" },
                            { skill: "Binary Search", level: 91, icon: "🔍", color: "from-indigo-500 to-blue-500" },
                            { skill: "Recursion", level: 80, icon: "🔄", color: "from-pink-500 to-red-500" }
                        ].map((item, index) => (
                            <motion.div
                                key={item.skill}
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {[
                            { category: "Arrays", count: 740, icon: "📊", difficulty: "Easy" },
                            ...
                            { category: "Hash Tables", count: 285, icon: "🗂️", difficulty: "Medium" },
                            { category: "DFS", count: 139, icon: "📈" },
                            { category: "Stacks & Queues", count: 80, icon: "📚", difficulty: "Easy" },
